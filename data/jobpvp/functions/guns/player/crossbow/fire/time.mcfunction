...
#
    execute if score $fireid ui_temp matches ..-1 at @s anchored eyes positioned ^-0.25 ^-0.1 ^0.7 run function jobpvp:guns/player/crossbow/fire/id/downer/fir_d
    execute if score $fireid ui_temp matches 1.. at @s anchored eyes positioned ^-0.25 ^-0.1 ^0.7 run function jobpvp:guns/player/crossbow/fire/id/upper/fir_u
