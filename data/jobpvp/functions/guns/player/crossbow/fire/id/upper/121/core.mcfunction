...
#
    ...
    execute if score $firetime.temp ui_temp matches 0 at @s rotated 0 0 run function jobpvp:guns/player/crossbow/fire/id/upper/121/particle
    execute if score $firetime.temp ui_temp matches 20 at @s rotated 0 0 run function jobpvp:guns/player/crossbow/fire/id/upper/121/particle
    execute if score $firetime.temp ui_temp matches 40 at @s rotated 0 0 run function jobpvp:guns/player/crossbow/fire/id/upper/121/particle
    execute if score $firetime.temp ui_temp matches 60 at @s rotated 0 0 run function jobpvp:guns/player/crossbow/fire/id/upper/121/particle
    execute if score $firetime.temp ui_temp matches 80 at @s rotated 0 0 run function jobpvp:guns/player/crossbow/fire/id/upper/121/particle
    execute if score $firetime.temp ui_temp matches 100 at @s rotated 0 0 run function jobpvp:guns/player/crossbow/fire/id/upper/121/particle
