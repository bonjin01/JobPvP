...
#
    ...
    execute if score $firetime.temp ui_temp matches 0 at @s positioned ~ ~0.1 ~ run function jobpvp:guns/player/crossbow/fire/id/upper/112/particle
    ...
    execute if score $firetime.temp ui_temp matches 53 at @s positioned ~ ~0.1 ~ run function jobpvp:guns/player/crossbow/fire/id/upper/112/particle
