...
#
    ...
    execute if score $firetime.temp ui_temp matches 0 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/119/particle
    execute if score $firetime.temp ui_temp matches 20 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/119/particle
    execute if score $firetime.temp ui_temp matches 40 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/119/particle
    execute if score $firetime.temp ui_temp matches 60 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/119/particle
    execute if score $firetime.temp ui_temp matches 80 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/119/particle
