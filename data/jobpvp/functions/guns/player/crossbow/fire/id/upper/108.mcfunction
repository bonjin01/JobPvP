...
#
    ...
    execute if score $firetime.temp ui_temp matches 30 at @s anchored eyes run summon wither_skull ^ ^ ^1.5 {Tags:["ui_temp_obj"]}
    execute if score $firetime.temp ui_temp matches 30 at @s anchored eyes run summon wither_skull ^ ^ ^1.5 {Tags:["ui_temp_obj"]}
    execute if score $firetime.temp ui_temp matches 30 at @s anchored eyes positioned ^ ^ ^1.5 as @e[tag=ui_temp_obj,limit=1] run function jobpvp:guns/player/crossbow/fire/id/upper/108.2
    execute if score $firetime.temp ui_temp matches 30 at @s anchored eyes positioned ^ ^ ^1.5 rotated ~5 ~ as @e[tag=ui_temp_obj,limit=1] run function jobpvp:guns/player/crossbow/fire/id/upper/108.2
    execute if score $firetime.temp ui_temp matches 30 at @s anchored eyes positioned ^ ^ ^1.5 rotated ~10 ~ as @e[tag=ui_temp_obj,limit=1] run function jobpvp:guns/player/crossbow/fire/id/upper/108.2
    execute if score $firetime.temp ui_temp matches 30 at @s anchored eyes positioned ^ ^ ^1.5 rotated ~-5 ~ as @e[tag=ui_temp_obj,limit=1] run function jobpvp:guns/player/crossbow/fire/id/upper/108.2
    execute if score $firetime.temp ui_temp matches 30 at @s anchored eyes positioned ^ ^ ^1.5 rotated ~-10 ~ as @e[tag=ui_temp_obj,limit=1] run function jobpvp:guns/player/crossbow/fire/id/upper/108.2
    execute if score $firetime.temp ui_temp matches 30 at @s anchored eyes positioned ^ ^ ^1.5 rotated ~ ~5 as @e[tag=ui_temp_obj,limit=1] run function jobpvp:guns/player/crossbow/fire/id/upper/108.2
    execute if score $firetime.temp ui_temp matches 30 at @s anchored eyes positioned ^ ^ ^1.5 rotated ~ ~10 as @e[tag=ui_temp_obj,limit=1] run function jobpvp:guns/player/crossbow/fire/id/upper/108.2
