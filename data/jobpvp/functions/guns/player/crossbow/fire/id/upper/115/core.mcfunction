...
#
    ...
    execute if score $firetime.temp ui_temp matches 0 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/115/particle
    execute if score $firetime.temp ui_temp matches 12 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/115/particle
    execute if score $firetime.temp ui_temp matches 24 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/115/particle
    execute if score $firetime.temp ui_temp matches 36 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/115/particle
    execute if score $firetime.temp ui_temp matches 48 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/115/particle
    execute if score $firetime.temp ui_temp matches 60 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/115/particle
