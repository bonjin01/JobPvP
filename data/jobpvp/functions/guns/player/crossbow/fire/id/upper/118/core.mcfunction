...
#
    ...
    execute if score $firetime.temp ui_temp matches 0 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/118/particle
    execute if score $firetime.temp ui_temp matches 20 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/118/particle
    execute if score $firetime.temp ui_temp matches 40 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/118/particle
    execute if score $firetime.temp ui_temp matches 60 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/118/particle
    execute if score $firetime.temp ui_temp matches 80 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/118/particle
    execute if score $firetime.temp ui_temp matches 100 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/118/particle
    execute if score $firetime.temp ui_temp matches 120 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/118/particle
    execute if score $firetime.temp ui_temp matches 140 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/118/particle
    execute if score $firetime.temp ui_temp matches 160 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/118/particle
    ...
    execute if score $firetime.temp ui_temp matches 160 run function jobpvp:guns/player/crossbow/fire/template/fire_burst
