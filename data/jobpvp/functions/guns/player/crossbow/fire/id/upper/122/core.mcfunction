...
#
    ...
    execute if score $firetime.temp ui_temp matches 0 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/122/particle2
    execute if score $firetime.temp ui_temp matches 100 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/122/particle2
    execute if score $firetime.temp ui_temp matches 200 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/122/particle2
    execute if score $firetime.mod ui_temp matches 0 at @s rotated ~0 0 run function jobpvp:guns/player/crossbow/fire/id/upper/121/particle
    execute if score $firetime.mod ui_temp matches 5 at @s rotated ~15 0 run function jobpvp:guns/player/crossbow/fire/id/upper/121/particle
    execute if score $firetime.mod ui_temp matches 10 at @s rotated ~30 0 run function jobpvp:guns/player/crossbow/fire/id/upper/121/particle
    execute if score $firetime.mod ui_temp matches 15 at @s rotated ~45 0 run function jobpvp:guns/player/crossbow/fire/id/upper/121/particle
    execute if score $firetime.mod ui_temp matches 0 if score $firetime.temp ui_temp matches 1..199 unless score $firetime.temp ui_temp matches 100 at @s run function jobpvp:guns/player/crossbow/fire/id/upper/122/particle
