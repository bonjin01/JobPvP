...
#
    ...
    execute if entity @s[tag=tmw_active_temp] if score $firetime.temp ui_temp matches 8..100 run function jobpvp:guns/player/crossbow/fire/template/calc
    ...
    execute if entity @s[tag=tmw_active_temp] if score $firetime.temp ui_temp matches 108..200 run function jobpvp:guns/player/crossbow/fire/template/calc
    ...
    execute if entity @s[tag=tmw_active_temp] if score $firetime.temp ui_temp matches 200..205 run function jobpvp:guns/player/crossbow/fire/template/calc
