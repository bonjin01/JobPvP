...
#
execute unless data storage ui:gun temp.NoUI if score $changedtype ui_temp matches 0 at @s run function jobpvp:guns/player/crossbow/changed/id/0
execute unless data storage ui:gun temp.NoUI if score $changedtype ui_temp matches ..-1 at @s run function jobpvp:guns/player/crossbow/changed/id/downer/chg_d
execute unless data storage ui:gun temp.NoUI if score $changedtype ui_temp matches 1.. at @s run function jobpvp:guns/player/crossbow/changed/id/upper/chg_u