# 射撃体勢！
    function jobpvp:guns/player/crossbow/constant/shoot
...
# メインプロセスに送信
    execute if score $shottype ui_temp matches 1 run function jobpvp:guns/player/crossbow/attack/shot/core
    execute if score $shottype ui_temp matches 2 if entity @s[nbt={OnGround:1b}] run function jobpvp:guns/player/crossbow/attack/roll/core
