...
# 弾を出す
    function jobpvp:guns/player/crossbow/attack/shot/fire_straight
...
# ショットガン.lp
    ...
    execute if score $multishot ui_temp matches 1.. at @e[tag=ui_marker] run function jobpvp:guns/player/crossbow/attack/shot/spreadmanager/3.2