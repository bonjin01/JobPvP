...
#
    execute if score $reloadid ui_temp matches ..-1 at @s run function jobpvp:guns/player/crossbow/reload/id/downer/rel_d
    execute if score $reloadid ui_temp matches 1.. at @s run function jobpvp:guns/player/crossbow/reload/id/upper/rel_u
