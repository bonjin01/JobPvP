...
# 装弾数が最大装弾数より少ないなら弾を消費
    ...
    execute if score $magazine ui_temp matches 1.. run function jobpvp:guns/player/crossbow/reload/ammo_checked
...
#
    execute if score $add ui_temp matches 1 run function jobpvp:guns/player/crossbow/reload/manager