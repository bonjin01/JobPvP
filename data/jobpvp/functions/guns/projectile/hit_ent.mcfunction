...
#
    execute if score $def_state ui_temp matches 0 run function jobpvp:guns/projectile/hit/state0
    execute if score $def_state ui_temp matches 1 run function jobpvp:guns/projectile/hit/state1
