...
# これヘッドショット？
    execute if score $weak_mult ui_temp matches 101.. run function jobpvp:guns/projectile/hit/weak_mult
    execute if score $back_mult ui_temp matches 101.. run function jobpvp:guns/projectile/hit/back_mult
