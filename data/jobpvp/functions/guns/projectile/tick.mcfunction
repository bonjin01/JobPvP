...
# 追加効果
#execute if score @s ui_bmods matches 1.. run function jobpvp:guns/projectile/modifiers

# 重力補正
function jobpvp:guns/projectile/gravity

# tick毎ループ
execute at @s[scores={ui_temp=10..}] run function jobpvp:guns/projectile/move
...
execute if score @s ui_bm <= @s ui_bm_lim at @s run function jobpvp:guns/projectile/end
execute if score @s ui_br_temp >= @s ui_br at @s run function jobpvp:guns/projectile/end
