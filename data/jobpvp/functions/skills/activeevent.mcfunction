...
execute unless data storage jobpvp: ActiveSkill{Hand:0b} if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].offhand.tag{ItemType:"skill",Itemdata:{Skill:{SkillType:"active"}}} run data modify storage jobpvp: ActiveSkill.Hand set value 1b
